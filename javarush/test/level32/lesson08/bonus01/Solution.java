...
public class Solution {
    ...
    public <T extends Item> T getProxy(Class<T> returnClass, Class... others){
        ClassLoader loader = returnClass.getClassLoader();
        Class<?>[] interfaces = new Class[others.length + 1];
        System.arraycopy(others, 0, interfaces, 0, others.length);
        interfaces[interfaces.length - 1] = returnClass;
