...
public class Solution {
    ...
    public static boolean isAllModifiersContainSpecificModifier(int allModifiers, int specificModifier) {
        String[] allMod = Modifier.toString(allModifiers).split(" ");
        String specMod = Modifier.toString(specificModifier);
        for (String mod : allMod){
            if (mod.equals(specMod)) return  true;
        }
        return false;
    }
