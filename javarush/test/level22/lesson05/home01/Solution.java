...
public class Solution {
    ...
    public String getPartOfString(String string, String threadName) {
        try{
            ...
            if (threadName.equals(Solution.FIRST_THREAD_NAME)) throw new RuntimeException(e.toString(), new TooShortStringFirstThreadException());
                else if (threadName.equals(Solution.SECOND_THREAD_NAME)) throw new RuntimeException(e.toString(), new TooShortStringSecondThreadException());
                        else throw new RuntimeException(e.toString(), e.getCause());
        }
    }
}
